...
namespace Com.NoirContactDT.Cady
{
    public class Launcher : MonoBehaviourPunCallbacks
    {
        ...
        public override void OnConnectedToMaster() // burasý sahne yüklendiði anda yüklenir.
        {
            if (isConnecting)
            {
